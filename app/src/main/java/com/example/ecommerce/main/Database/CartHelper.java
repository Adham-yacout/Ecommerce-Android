package com.example.ecommerce.main.Database;
...
public class CartHelper extends SQLiteOpenHelper {
    ...
    public void addCart(Context ctx, String userid, String email, String id, String title, float price,
...
if (cursor.moveToFirst())
{
    ...
    public void UpdateItemquantity(String userid, String email, String id, String title, float price,
                           String description, String category, String images, String quantity)
    {
        SQLiteDatabase db = this.getReadableDatabase();
